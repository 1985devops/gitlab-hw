...
1. `Установил на яндекс облаке виртуальную машину с debian 12. Поставил PostgreSQL. Для установки достаточна та версия, что есть в системном репозитороии Debian 11`
